...
const initialState = {
    ...
    showDetailsUsersDrawerIsOpened: false,
}
...
const miscSlice = createSlice({
    ...
    reducers: {
        ...
        openShowDetailsUsersDrawer: (state)=>{state.showDetailsUsersDrawerIsOpened = true},
        closeShowDetailsUsersDrawer: (state)=>{state.showDetailsUsersDrawerIsOpened = false},
    }
})
