  ...
  const fetchInvoiceDetails = async () => {
    ...
    try {
      ...
      setDetails({
        ...
        customertype:
          data.invoice.customer?.people ? "Individual" : "Corporate",
        customer:
          data.invoice.customer?.people ? (data.invoice.customer?.people.firstname + ' ' + data.invoice.customer?.people.lastname) : data.invoice.customer?.company.companyname,
