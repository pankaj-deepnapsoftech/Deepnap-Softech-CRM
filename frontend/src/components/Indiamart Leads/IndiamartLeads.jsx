...
const IndiamartLeads = () => {
  ...
  return (
    <>
      <div
        className="relative border-[1px] px-2 py-8 md:px-9 rounded"
        style={{ boxShadow: "0 0 20px 3px #96beee26" }}
      >
        <div className="text-xl text-red-500 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">Indiamart API Needed</div>
            ...
            >
              <AlertDialogOverlay>
                <AlertDialogContent>
                  ...
                  <AlertDialogBody>
                    Are you sure, deleting a Lead will also delete its corresponding Offers?
                  </AlertDialogBody>
